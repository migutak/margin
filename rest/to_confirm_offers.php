<?php
    ...
    ,ccypair,orderdate,buyorderamount+sellorderamount orderamount,buysell,buysellbank,if(buysell='BUY' AND buyorderamount>0,3,-3) limitnum,currentstatus,recipient,comment, 
    ...
    from offers left outer join custorders on offers.orderidfk = custorders.orderid where status = 'Accepted' and confirm = 'Sent' and recipient = offeredby", $db);  

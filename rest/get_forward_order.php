<?php
    ...
    $result = mysql_query("select orderindex,orderid,usernamefk,ccypair,orderdate, buyorderamountccy,buyorderamount,sellorderamountccy,sellorderamount,
    settlementdate,recipient,buysell,buysellbank,currentstatus,custcomment,ordertypefk from Forwardorders where orderindex = $id ", $db);

<?php
    ...
    $result = mysql_query("select distinct orderid,usernamefk,ccypair,orderdate,sellorderamount+buyorderamount orderamount,sellorderamount,buyorderamount,buysell,buysellbank,currentstatus,
    settlementdate,custcomment,ordertypefk,nOffers from custorders left outer join v_orders on custorders.orderid=v_orders.orderidfk where custorders.currentstatus = 'N'", $db);  
